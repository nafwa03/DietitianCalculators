	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (activity != null) {
			if ( HEADER_DATASTORE.equals(settings)) {
				addPreferencesFromResource(com.example.nafwa03.dietitiancalculators.R.xml.preferences_calculators);
				activity.setTitle(com.example.nafwa03.dietitiancalculators.R.string.preference_title_calculators);
				/*
